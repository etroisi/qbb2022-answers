...
sigma = [] #make a list
for i, line in enumerate(open('needleman-wunsch/BLOSUM62.txt')):#use hoxd
    #print(i, line)
...
input_sequences = readFASTA(open('needleman-wunsch/CTCF_38_M27_AA.faa'))#use dna file
...
gap_penalty = -10#use different number, but put it as an argument ie sys.argv[whichever number it is in the command line]
for i in range(len(sequence1)+1):
